...
public class ViviendaModel extends FormModel {
	...
	n_ninhos = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_NINHOS"), oldValue,
		newValue);
    }
	...
	n_ninhas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_NINHAS"), oldValue,
		newValue);
    }
	...
	n_mujer = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_MUJER"), oldValue,
		newValue);
    }
	...
	n_hombr = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_HOMBR"), oldValue,
		newValue);
    }
	...
	edad_produ = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("EDAD_PRODU"), oldValue,
		newValue);
    }
	...
	n_personas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_PERSONAS"), oldValue,
		newValue);
    }
	...
	direccion = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("DIRECCION"), oldValue,
		newValue);
    }
	...
	nid_produ = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NID_PRODU"), oldValue,
		newValue);
    }
	...
	n_embaraz = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_EMBARAZ"), oldValue,
		newValue);
    }
	...
	nom_produ = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOM_PRODU"), oldValue,
		newValue);
    }
	...
	otros_ing = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OTROS_ING"), oldValue,
		newValue);
    }
	...
	otras_act = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OTRAS_ACT"), oldValue,
		newValue);
    }
	...
	n_migrante = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("N_MIGRANTE"), oldValue,
		newValue);
    }
	...
	ot_stat_vi = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_STAT_VI"), oldValue,
		newValue);
    }
	...
	ot_mat_pa = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_MAT_PA"), oldValue,
		newValue);
    }
	...
	ot_mat_te = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_MAT_TE"), oldValue,
		newValue);
    }
	...
	ot_mat_pi = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_MAT_PI"), oldValue,
		newValue);
    }
	...
	ot_dep_alm = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_DEP_ALM"), oldValue,
		newValue);
    }
	...
	cual_ch = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CUAL_CH"), oldValue,
		newValue);
    }
	...
	tip_migra = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("TIP_MIGRA"), oldValue,
		newValue);
    }
	...
	mig_dest = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MIG_DEST"), oldValue,
		newValue);
    }
	...
	estatus_vi = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("ESTATUS_VI"), oldValue,
		newValue);
    }
	...
	mat_pared = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MAT_PARED"), oldValue,
		newValue);
    }
	...
	mat_techo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MAT_TECHO"), oldValue,
		newValue);
    }
	...
	mat_piso = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MAT_PISO"), oldValue,
		newValue);
    }
	...
	pro_vivsex = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PRO_VIVSEX"), oldValue,
		newValue);
    }
	...
	agricult = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("AGRICULT"), oldValue,
		newValue);
    }
	...
	comercio = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COMERCIO"), oldValue,
		newValue);
    }
	...
	hay_ot_act = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_OT_ACT"), oldValue,
		newValue);
    }
	...
	remesas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("REMESAS"), oldValue,
		newValue);
    }
	...
	hay_ot_ing = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_OT_ING"), oldValue,
		newValue);
    }
	...
	e_temporal = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("E_TEMPORAL"), oldValue,
		newValue);
    }
	...
	ganaderia = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("GANADERIA"), oldValue,
		newValue);
    }
	...
	e_perman = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("E_PERMAN"), oldValue,
		newValue);
    }
	...
	pro_viv = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PRO_VIV"), oldValue,
		newValue);
    }
	...
	luz_elec = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("LUZ_ELEC"), oldValue,
		newValue);
    }
	...
	telefono = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("TELEFONO"), oldValue,
		newValue);
    }
	...
	agua_pot = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("AGUA_POT"), oldValue,
		newValue);
    }
	...
	alcantar = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("ALCANTAR"), oldValue,
		newValue);
    }
	...
	hay_in_viv = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_IN_VIV"), oldValue,
		newValue);
    }
	...
	alum_publ = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("ALUM_PUBL"), oldValue,
		newValue);
    }
	...
	silos = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("SILOS"), oldValue,
		newValue);
    }
	...
	trojas_mej = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("TROJAS_MEJ"), oldValue,
		newValue);
    }
	...
	sacos = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("SACOS"), oldValue,
		newValue);
    }
	...
	coc_mejor = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COC_MEJOR"), oldValue,
		newValue);
    }
	...
	filtro_ag = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("FILTRO_AG"), oldValue,
		newValue);
    }
	...
	gallinero = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("GALLINERO"), oldValue,
		newValue);
    }
	...
	ramadas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("RAMADAS"), oldValue,
		newValue);
    }
	...
	letrina = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("LETRINA"), oldValue,
		newValue);
    }
	...
	consumo_h = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CONSUMO_H"), oldValue,
		newValue);
    }
	...
	sist_rieg = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("SIST_RIEG"), oldValue,
		newValue);
    }
	...
	cap_techo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CAP_TECHO"), oldValue,
		newValue);
    }
	...
	dep_almac = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("DEP_ALMAC"), oldValue,
		newValue);
    }
    ...
    /*
     * //map with non-widget values public Map<String, String>
     * getNonwidgetvalues(){ return nonWidgetValues; }
     * 
     * public String getNonwidgetvalues(String key) { return
     * nonWidgetValues.get(key); }
     * 
     ...
     * // map with widget values
     * 
     * @Override public Map<String, String> getWidgetValues() { return
     * widgetValues; }
     */
}
