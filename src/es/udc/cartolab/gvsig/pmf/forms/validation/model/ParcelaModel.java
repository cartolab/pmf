...
public class ParcelaModel extends FormModel {
	...
	nom_com = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOM_COM"), oldValue,
		newValue);
    }
	...
	cod_viv = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COD_VIV"), oldValue,
		newValue);
    }
	...
	cod_com = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COD_COM"), oldValue,
		newValue);
    }
	...
	area_tot = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("AREA_TOT"), oldValue,
		newValue);
    }
	...
	codigo_fc = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CODIGO_FC"), oldValue,
		newValue);
    }
	...
	ot_legal_p = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_LEGAL_P"), oldValue,
		newValue);
    }
	...
	d_fue_tan = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("D_FUE_TANO"), oldValue,
		newValue);
    }
	...
	d_tan_hue = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("D_TAN_HUEO"), oldValue,
		newValue);
    }
	...
	area_cul = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("AREA_CUL"), oldValue,
		newValue);
    }
	...
	otrocspe = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OTROCSPE"), oldValue,
		newValue);
    }
	...
	ot_tip_su = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_TIP_SU"), oldValue,
		newValue);
    }
	...
	ot_cerca = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OT_CERCA"), oldValue,
		newValue);
    }
	...
	otrocan = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("OTROCAN"), oldValue,
		newValue);
    }
	...
	c_conse = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("C_CONSE"), oldValue,
		newValue);
    }
	...
	c_aborg = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("C_ABORG"), oldValue,
		newValue);
    }
	...
	c_insect = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("C_INSECT"), oldValue,
		newValue);
    }
	...
	c_quim = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("C_QUIM"), oldValue,
		newValue);
    }
	...
	p_riego = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("P_RIEGO"), oldValue,
		newValue);
    }
	...
	p_huerto = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("P_HUERTO"), oldValue,
		newValue);
    }
	...
	p_filtroag = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("P_FILTROAG"), oldValue,
		newValue);
    }
	...
	p_galline = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("P_GALLINE"), oldValue,
		newValue);
    }
	...
	fam_cant = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("FAM_CANT"), oldValue,
		newValue);
    }
	...
	fam_per = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("FAM_PER"), oldValue,
		newValue);
    }
	...
	con_cant = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CON_CANT"), oldValue,
		newValue);
    }
	...
	con_per = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CON_PER"), oldValue,
		newValue);
    }

    public String getP_coc_mejo() {
	return p_coc_mejo;
    }

    public void setP_coc_mejo(String newValue) {
	String oldValue = getP_coc_mejo();
	p_coc_mejo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("P_COC_MEJO"), oldValue,
		newValue);
    }
	...
	pro_finsex = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PRO_FINSEX"), oldValue,
		newValue);
    }
	...
	legal_par = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("LEGAL_PAR"), oldValue,
		newValue);
    }
	...
	tip_suelo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("TIP_SUELO"), oldValue,
		newValue);
    }
    ...
    public void setPendiente(String newValue) {
	String oldValue = getPendiente();
	pendiente = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PENDIENTE"), oldValue,
		newValue);
    }
	...
	deg_suelo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("DEG_SUELO"), oldValue,
		newValue);
    }
	...
	reserv = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("RESERV"), oldValue,
		newValue);
    }
	...
	nacimiento = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NACIMIENTO"), oldValue,
		newValue);
    }
	...
	rio = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("RIO"), oldValue,
		newValue);
    }
	...
	poz_pro = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("POZ_PRO"), oldValue,
		newValue);
    }

    public boolean getFuente_co() {
	return fuente_co;
    }

    public void setFuente_co(boolean newValue) {
	boolean oldValue = getFuente_co();
	fuente_co = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("FUENTE_CO"), oldValue,
		newValue);
    }
	...
	poz_com = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("POZ_COM"), oldValue,
		newValue);
    }
	...
	no_fuen = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NO_FUEN"), oldValue,
		newValue);
    }
	...
	b_vivas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("B_VIVAS"), oldValue,
		newValue);
    }
	...
	b_muertas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("B_MUERTAS"), oldValue,
		newValue);
    }
	...
	maiz = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MAIZ"), oldValue,
		newValue);
    }
	...
	yuca = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("YUCA"), oldValue,
		newValue);
    }

    public boolean getNo_cultivo() {
	return no_cultivo;
    }

    public void setNo_cultivo(boolean newValue) {
	boolean oldValue = getNo_cultivo();
	no_cultivo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NO_CULTIVO"), oldValue,
		newValue);
    }
	...
	musacea = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MUSACEA"), oldValue,
		newValue);
    }
	...
	hay_ot_sp = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_OT_SP"), oldValue,
		newValue);
    }
	...
	arbfor = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("ARBFOR"), oldValue,
		newValue);
    }
	...
	noarb = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOARB"), oldValue,
		newValue);
    }

    public boolean getNo_cul_sem() {
	return no_cul_sem;
    }

    public void setNo_cul_sem(boolean newValue) {
	boolean oldValue = getNo_cul_sem();
	no_cul_sem = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NO_CUL_SEM"), oldValue,
		newValue);
    }
	...
	pasto = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PASTO"), oldValue,
		newValue);
    }
	...
	arbfru = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("ARBFRU"), oldValue,
		newValue);
    }
	...
	hortalizas = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HORTALIZAS"), oldValue,
		newValue);
    }
	...
	papaya = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PAPAYA"), oldValue,
		newValue);
    }
	...
	hay_ot_cer = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_OT_CER"), oldValue,
		newValue);
    }
	...
	prac_conse = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("PRAC_CONSE"), oldValue,
		newValue);
    }
	...
	uso_aborg = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("USO_ABORG"), oldValue,
		newValue);
    }
	...
	insect_org = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("INSECT_ORG"), oldValue,
		newValue);
    }
	...
	uso_quim = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("USO_QUIM"), oldValue,
		newValue);
    }
	...
	maicillo = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MAICILLO"), oldValue,
		newValue);
    }
	...
	frijol = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("FRIJOL"), oldValue,
		newValue);
    }
	...
	hay_ot_cul = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_OT_CUL"), oldValue,
		newValue);
    }
	...
	hay_in_par = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("HAY_IN_CUL"), oldValue,
		newValue);
    }
	...
	cerca = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("CERCA"), oldValue,
		newValue);
    }
	...
	widgetValues.put("fuente_co", String.valueOf(fuente_co));
	...
	widgetValues.put("no_cultivo", String.valueOf(no_cultivo));
	...
	widgetValues.put("no_cul_sem", String.valueOf(no_cul_sem));
