...
public class ParcelaModel extends FormModel {
  ...
  @Override
    ...
    public void setP_coc_mejo(String newValue) {
        ...
        p_coc_mejo = newValue;
        firePropertyChange((String) PROPERTIES_MAP.get("P_COC_MEJO"), oldValue, newValue);
    }
    ...
    public void setPendiente(String newValue) {
        ...
        pendiente = newValue;
        firePropertyChange((String) PROPERTIES_MAP.get("PENDIENTE"), oldValue, newValue);
    }
    ...
    public void setFuente_co(boolean newValue) {
        ...
        fuente_co = newValue;
        firePropertyChange((String) PROPERTIES_MAP.get("FUENTE_CO"), oldValue, newValue);
    }
    ...
    public void setNo_cultivo(boolean newValue) {
        ...
        no_cultivo = newValue;
        firePropertyChange((String) PROPERTIES_MAP.get("NO_CULTIVO"), oldValue, newValue);
    }
    ...
    public void setNo_cul_sem(boolean newValue) {
        ...
        no_cul_sem = newValue;
        firePropertyChange((String) PROPERTIES_MAP.get("NO_CUL_SEM"), oldValue, newValue);
    }
