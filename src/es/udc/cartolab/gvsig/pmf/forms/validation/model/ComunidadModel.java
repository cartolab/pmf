...
public class ComunidadModel extends FormModel {
	...
	x = newValue;
	firePropertyChange(PROPERTIES_MAP.get("X"), oldValue, newValue);
    }
	...
	y = newValue;
	firePropertyChange(PROPERTIES_MAP.get("Y"), oldValue, newValue);
    }
	...
	z = newValue;
	firePropertyChange(PROPERTIES_MAP.get("Z"), oldValue, newValue);
    }
