...
public class CentroReunionesModel extends FormModel {
	...
	cod_creu = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COD_CREU"), oldValue,
		newValue);
    }
	...
	nom_creu = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOM_CREU"), oldValue,
		newValue);
    }
	...
	responsa = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("RESPONSA"), oldValue,
		newValue);
    }
