...
public final class ComunidadValidator implements Validator<ComunidadModel> {
	...
	if (!ValidationUtils.isNumeric(comunidadModel.getN_habit())) {
	    support.addError("n_habit", "debe ser un numero entero");
	...
	if (!ValidationUtils.isNumeric(comunidadModel.getN_fam())) {
	    support.addError("n_fam", "debe ser un numero entero");
	...
	// ***************************************
	// x
	if (!ValidationCheckingUtils.isReal(comunidadModel.getX())) {
	    support.addError("x", "debe ser un numero");
	} else if (ValidationUtils.isBlank(comunidadModel.getX())) {
	    support.addError("x", "es obligatorio");
	}

	// y
	if (!ValidationCheckingUtils.isReal(comunidadModel.getY())) {
	    support.addError("y", "debe ser un numero");
	} else if (ValidationUtils.isBlank(comunidadModel.getY())) {
	    support.addError("y", "es obligatorio");
	}

	// z
	if (!ValidationCheckingUtils.isReal(comunidadModel.getZ())) {
	    support.addError("z", "debe ser un numero");
	} else if (ValidationUtils.isBlank(comunidadModel.getZ())) {
