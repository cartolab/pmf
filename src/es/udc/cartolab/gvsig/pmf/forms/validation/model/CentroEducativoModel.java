...
public class CentroEducativoModel extends FormModel {
	...
	i_deserc = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("I_DESERC"), oldValue,
		newValue);
    }
	...
	nom_cedu = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOM_CEDU"), oldValue,
		newValue);
    }
	...
	cod_cedu = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COD_CEDU"), oldValue,
		newValue);
    }
	...
	tipo_cedu = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("TIPO_CEDU"), oldValue,
		newValue);
    }
	...
	mer_escol = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("MER_ESCOL"), oldValue,
		newValue);
    }
