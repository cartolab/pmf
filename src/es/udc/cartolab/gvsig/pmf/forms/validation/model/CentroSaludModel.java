...
public class CentroSaludModel extends FormModel {
	...
	cod_csalud = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("COD_CSALUD"), oldValue,
		newValue);
    }
	...
	edad_men5 = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("EDAD_MEN5"), oldValue,
		newValue);
    }
	...
	edad_may5 = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("EDAD_MAY5"), oldValue,
		newValue);
    }
	...
	nom_csalud = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("NOM_CSALUD"), oldValue,
		newValue);
    }
	...
	inf_resp = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("INF_RESP"), oldValue,
		newValue);
    }
	...
	inf_piel = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("INF_PIEL"), oldValue,
		newValue);
    }
	...
	inf_inst = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("INF_INST"), oldValue,
		newValue);
    }
	...
	inf_vec = newValue;
	firePropertyChange((String) PROPERTIES_MAP.get("INF_VEC"), oldValue,
		newValue);
    }
