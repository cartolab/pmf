...
public final class CentroReunionesValidator implements
	Validator<CentroReunionesModel> {
	...
	PropertyValidationSupport support = new PropertyValidationSupport(
		centroReunionesModel, "CentroReunionesModel");

	if (ValidationUtils.isBlank(centroReunionesModel.getCod_creu())) {
	    support.addError("cod_creu", PluginServices.getText(this,
		    "needed_is_pk"));
	}
