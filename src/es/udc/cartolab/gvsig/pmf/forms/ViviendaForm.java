...
public class ViviendaForm extends AbstractForm {
    ...
    private void checkBoxEnablesComboBox(String checkBoxName,
	    String comboBoxName) {
	JCheckBox checkBox = (JCheckBox) formBody
		.getComponentByName(checkBoxName);
	JComboBox comboBox = (JComboBox) formBody
	...
	super.setListeners();
	JCheckBox hay_ot_act = (JCheckBox) formBody
		.getComponentByName("hay_ot_act.CHB");
	hay_ot_act.setActionCommand("otras_act");
	hay_ot_act.addActionListener(this);
	JCheckBox hay_ot_ing = (JCheckBox) formBody
		.getComponentByName("hay_ot_ing.CHB");
	hay_ot_ing.setActionCommand("otros_ing");
	hay_ot_ing.addActionListener(this);
	JComboBox estatus_vi = (JComboBox) formBody
		.getComponentByName("estatus_vi.CB");
	estatus_vi.setActionCommand("ot_stat_vi");
	estatus_vi.addActionListener(this);
	JCheckBox pro_viv = (JCheckBox) formBody
		.getComponentByName("pro_viv.CHB");
	pro_viv.setActionCommand("pro_vivsex");
	pro_viv.addActionListener(this);
	JComboBox mat_piso = (JComboBox) formBody
		.getComponentByName("mat_piso.CB");
	mat_piso.setActionCommand("ot_mat_pi");
	mat_piso.addActionListener(this);
	JComboBox mat_pared = (JComboBox) formBody
		.getComponentByName("mat_pared.CB");
	mat_pared.setActionCommand("ot_mat_pa");
	mat_pared.addActionListener(this);
	JComboBox mat_techo = (JComboBox) formBody
		.getComponentByName("mat_techo.CB");
	mat_techo.setActionCommand("ot_mat_te");
	mat_techo.addActionListener(this);
	JCheckBox consumo_h = (JCheckBox) formBody
		.getComponentByName("consumo_h.CHB");
	consumo_h.setActionCommand("cual_ch");
	consumo_h.addActionListener(this);
	JCheckBox dep_almac = (JCheckBox) formBody
		.getComponentByName("dep_almac.CHB");
